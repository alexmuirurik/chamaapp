<aside class="sidebar rounded-end-2" id="sidebar-main">
    <div class="sidebar-head d-flex align-items-center ps-3">
        <i class="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute end-0 top-0 d-none d-xl-none"
            aria-hidden="true" id="iconSidenav"></i>
        <a class="navbar-brand" href="{{ route('index') }}" target="_blank">
            <img src="{{asset('assets/img/logo-ct-dark.png')}}" class="img-fluid" alt="main_logo" height="30" width="30">
    ...
    <div class="sidebar-body w-auto" id="sidenav-collapse-main">
        <ul class="nav navbar-nav">
            ...
            <li class="nav-item ps-4 py-2 mb-1 {{ Route::currentRouteName() == 'members.index' ? 'active' : '' }}">
                <a class="nav-link d-flex" href="{{ route('members.index') }}">
                    <div class="icon">
            ...
            <li class="nav-item ps-4 py-2 mb-1{{ str_contains(request()->url(), 'meetings') == true ? 'active' : '' }}">
                <a class="nav-link d-flex " href="{{ route('meetings.index') }}">
                    <div class="icon">
            ...
            <li class="nav-item ps-4 py-2 mb-1 {{ str_contains(request()->url(), 'deposits') == true ? 'active' : '' }}">
                <a class="nav-link d-flex" href="{{ route('deposits.index') }}">
                    <div class="icon">
            ...
            <li class="nav-item ps-4 py-2 mb-1 {{ str_contains(request()->url(), 'loans') == true ? 'active' : '' }}">
                <a class="nav-link d-flex" href="{{ route('loans.index') }}">
                    <div class="icon">
            ...
            <li class="nav-item ps-4 py-2 mb-1 {{ Route::currentRouteName() == 'shares' ? 'active' : '' }}">
                <a class="nav-link d-flex" href="{{ route('shares.index') }}">
                    <div class="icon">
            ...
            <li class="nav-item ps-4 py-2 mb-1 {{ Route::currentRouteName() == 'chama' ? 'active' : '' }}">
                <a class="nav-link d-flex" href="{{ route('chama.index') }}">
                    <div class="icon">
